...
/*Task 1: counterMaker()
  ...
  1. What is the difference between counter1 and counter2?
      ...
      The variable count is declared inside the function on counter1 and then outside globally in counter2.

  2. Which of the two uses a closure? How can you tell?

      Counter1 uses a closure beacause of the return function counter ()
  
  3. In what scenario would the counter1 code be preferable? In what scenario would 
     counter2 be better?  

     counter1 would be preferable if you want to keep the existing memory from previous logs where as counter2 would be better if you wanted a clean slate everytime.
*/
...
function scoreboard(getInningScoreCB, inningCB, numInnings) {
  ...
  for (let i = 0; i < numInnings; i++){
    ...
    scoreByInning.push(`Inning ${i + 1}: Home ${currentInning.Home} - Away${currentInning.Away}`);
  } 
